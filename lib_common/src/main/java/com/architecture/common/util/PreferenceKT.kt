 ...
 */
class PreferenceKT<T>(val context: Context, val string:String, val default : T) : ReadWriteProperty<Any?, T> {

    override fun getValue(thisRef: Any?, property: KProperty<*>): T {
        return findPreference(string, default)
    }

    val prefs:SharedPreferences by lazy{context.getSharedPreferences(string,Context.MODE_PRIVATE)}
